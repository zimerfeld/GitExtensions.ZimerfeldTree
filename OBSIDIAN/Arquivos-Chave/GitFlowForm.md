...
- **Finish release** roda o fluxo completo automático (merge em main + tag + merge em develop + push de tudo). Ver o mapa Start→git puro em [[../Sistema/Visão Geral]].

## Botão Initialize

Aplica de uma vez as chaves `gitflow.*` padrão — ver [[git flow - chaves de config (CLI)]].
...
- [[../Fluxos/2 - GitFlow (Start a Finish)]]
