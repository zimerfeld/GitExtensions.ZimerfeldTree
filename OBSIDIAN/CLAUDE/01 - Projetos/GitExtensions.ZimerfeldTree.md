...
tipo: projeto
criado: 2026-06-01
atualizado: 2026-06-16 (1.0.322: ícones Pull/Push nos botões e menu; verificação do remoto ao abrir via fetch da branch atual; menu Baixar/Enviar age na branch clicada; aviso bloqueia push quando a branch está atrás; cabeçalho com a branch em checkout no menu de contexto)
...
## 🔢 Versionamento
- Versão atual: **1.0.322** (README + csproj + nuspec em sincronia)
