...
- **Branch real não pode ser nó-pai** de outra (o ref seria arquivo **e** diretório). Ver [[🌿 Hierarquia de branches — branches no mesmo commit (PT)|🌿 Hierarquia de branches — branches no mesmo commit]].
