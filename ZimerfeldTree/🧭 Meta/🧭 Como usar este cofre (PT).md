...
> No **início** de cada sessão, leia: [[🏠 Home (PT)|🏠 Home]], [[📌 Backlog (PT)|📌 Backlog]], [[🔑 Fatos-Chave (PT)|🔑 Fatos-Chave]] e a nota-mãe [[🌳 GitExtensions.ZimerfeldTree (PT)|🌳 GitExtensions.ZimerfeldTree]].
> No **fim** de cada sessão, atualize o [[📌 Backlog (PT)|📌 Backlog]] e as notas afetadas.
...
- **Dataview** — opcional; a [[🏠 Home (PT)|🏠 Home]] atual não depende dele.
