...
Implementa as sequências de start / publish / track / update / finish para os cinco tipos. O mapa completo **Start→git** está em [[👁️ Visão Geral]] e [[🔀 GitFlow em git puro]].
