...
- **`BranchInfo`** — classe com os dados de uma branch/tag (nome, tipo, se é a atual, contadores ahead/behind, ref pai etc.), usada por [[⚙️ BranchHierarchyService]] ao montar a árvore.
