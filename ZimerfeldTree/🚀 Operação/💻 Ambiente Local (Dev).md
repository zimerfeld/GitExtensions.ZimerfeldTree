...
> [!abstract] 🎯 Objetivo
> Compilar o plugin **ZimerfeldTree** e instalá-lo no GitExtensions local para desenvolver e testar. Conteúdo derivado de [[🔧 build.ps1]], [[🏷️ Versionamento]] e [[📘 README — Instalação, Uso e Build]].
...
- **Versionamento** `major.minor.BUILD` — só o `BUILD` é incrementado automaticamente; fonte da verdade: `.nuspec` / `.csproj`. Ver [[🏷️ Versionamento]].
...
- Detalhes de instalação de cada dependência: [[📦 Dependências do ZimerfeldTree]].
...
- [[🏷️ Versionamento]] — esquema de versão e ciclo completo
- [[📦 Dependências do ZimerfeldTree]] — instalação passo a passo das dependências
- [[📘 README — Instalação, Uso e Build]] — espelho do README
- [[🚀 Deploy em Produção (Prod)]] — publicação da release
